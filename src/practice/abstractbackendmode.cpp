...
void Practice::AbstractBackendMode::updateGrades()
{
    ...
    updateGrade(*translation, m_frontend->resultState() == AbstractFrontend::AnswerCorrect, m_current->statisticBadCount() == 0);
...
void Practice::AbstractBackendMode::updateGrade(KEduVocText &text, bool isCorrectAnswer, bool hasNoPreviousBadAnswers)
{
    if (isCorrectAnswer) {
