...
void Script::activate()
{
    ...
    if (!m_activated) {
        ...
        m_errorMessage = "<p><strong>" + i18n("Error in file %1 at line %2:", fileName(), action->errorLineNo()) + "</strong><br/>" + msg + "<br/><strong>"
            + i18nc("debug information in error message", "Backtrace:") + "</strong><br/>" + trace + "</p>";
    }
}
