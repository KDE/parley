...
public slots:
    ...
    /**
     * Sets the @p conjugation of the verb in the given @p tense, @p number and @p person. Use this method instead of setConjugationText when the grades,
     * practice count etc are important and want them to be set in this conjugation
     ...
     * @return A String list with 15 entries. First 5 are for Singular [First, Second, ThirdMale, ThirdFemale, ThirdNeutral/Third], next 5 for Dual (in a
     * similar way) and last 5 for plural.
     */
