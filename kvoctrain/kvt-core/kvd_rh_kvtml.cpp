...

{
  ...
  do {
    ...
    if (elem.tag () == KV_ARTICLE_GRP) {
      if (inEntry) {
        errorKvtMl (xml.lineNumber(),
                    i18n("unallowed occurence of tag <%1>").arg(KV_ARTICLE_GRP));
        return false;
      }
      if (! elem.isEndTag ()) {
        errorKvtMl (xml.lineNumber(),
      ...
      if (! elem.isEndTag ()) {
        if (inEntry) {
          errorKvtMl (xml.lineNumber(),
                      i18n("unallowed occurence of tag <%1>").arg(KV_ART_ENTRY));
          return false;
        }
        inEntry = true;
      ...
      if (!inEntry) {
        errorKvtMl (xml.lineNumber(),
                    i18n("unallowed occurence of tag <%1>").arg(KV_ART_FD));
        return false;
      }
      ...
      if (!inEntry) {
        errorKvtMl (xml.lineNumber(),
                    i18n("unallowed occurence of tag <%1>").arg(KV_ART_FI));
        return false;
      }
      ...
      if (!inEntry) {
        errorKvtMl (xml.lineNumber(),
                    i18n("unallowed occurence of tag <%1>").arg(KV_ART_MD));
        return false;
      }
      ...
      if (!inEntry) {
        errorKvtMl (xml.lineNumber(),
                    i18n("unallowed occurence of tag <%1>").arg(KV_ART_MI));
        return false;
      }
      ...
      if (!inEntry) {
        errorKvtMl (xml.lineNumber(),
                    i18n("unallowed occurence of tag <%1>").arg(KV_ART_ND));
        return false;
      }
      ...
      if (!inEntry) {
        errorKvtMl (xml.lineNumber(),
                    i18n("unallowed occurence of tag <%1>").arg(KV_ART_NI));
        return false;
      }
...

{
  ...
  do {
    ...
    if (elem.tag () == KV_CONJUG_GRP) {
      if (inEntry) {
        errorKvtMl (xml.lineNumber(),
                    i18n("unallowed occurence of tag <%1>").arg(KV_CONJUG_GRP));
        return false;
      }
      if (! elem.isEndTag ()) {
        errorKvtMl (xml.lineNumber(),
      ...
      if (! elem.isEndTag ()) {
        if (inEntry) {
          errorKvtMl (xml.lineNumber(),
                      i18n("unallowed occurence of tag <%1>").arg(entry_tag));
          return false;
        }
        inEntry = true;
      ...
      if (!inEntry) {
        errorKvtMl (xml.lineNumber(),
                    i18n("unallowed occurence of tag <%1>").arg(KV_CON_P1S));
        return false;
      }
      ...
      if (!inEntry) {
        errorKvtMl (xml.lineNumber(),
                    i18n("unallowed occurence of tag <%1>").arg(KV_CON_P2S));
        return false;
      }
      ...
      if (!inEntry) {
        errorKvtMl (xml.lineNumber(),
                    i18n("unallowed occurence of tag <%1>").arg(KV_CON_P3SF));
        return false;
      }
      ...
      if (!inEntry) {
        errorKvtMl (xml.lineNumber(),
                    i18n("unallowed occurence of tag <%1>").arg(KV_CON_P3SM));
        return false;
      }
      ...
      if (!inEntry) {
        errorKvtMl (xml.lineNumber(),
                    i18n("unallowed occurence of tag <%1>").arg(KV_CON_P3SN));
        return false;
      }
      ...
      if (!inEntry) {
        errorKvtMl (xml.lineNumber(),
                    i18n("unallowed occurence of tag <%1>").arg(KV_CON_P1P));
        return false;
      }
      ...
      if (!inEntry) {
        errorKvtMl (xml.lineNumber(),
                    i18n("unallowed occurence of tag <%1>").arg(KV_CON_P2P));
        return false;
      }
      ...
      if (!inEntry) {
        errorKvtMl (xml.lineNumber(),
                    i18n("unallowed occurence of tag <%1>").arg(KV_CON_P3PF));
        return false;
      }
      ...
      if (!inEntry) {
        errorKvtMl (xml.lineNumber(),
                    i18n("unallowed occurence of tag <%1>").arg(KV_CON_P3PM));
        return false;
      }
      ...
      if (!inEntry) {
        errorKvtMl (xml.lineNumber(),
                    i18n("unallowed occurence of tag <%1>").arg(KV_CON_P3PN));
        return false;
      }
