/****************************************************************************
** Form implementation generated from reading ui file 'LessonInputDlg.ui'
**
** Created: Mon Oct 8 21:10:56 2001
...
/* 
 *  Constructs a LessonInputDlgForm which is a child of 'parent', with the 
 *  name 'name' and widget flags set to 'f' 
 *
 *  The dialog will by default be modeless, unless you set 'modal' to
 *  TRUE to construct a modal dialog.
 */
LessonInputDlgForm::LessonInputDlgForm( QWidget* parent,  const char* name, bool modal, WFlags fl )
    : QDialog( parent, name, modal, fl )
{
    ...
    title_label->setText( tr( "Lesson description" ) );
    ...
    e_title->setMinimumSize( QSize( 360, 0 ) );
 ...
 */
LessonInputDlgForm::~LessonInputDlgForm()
{
