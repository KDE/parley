...
#ifndef UsageOptPageData_included
#define UsageOptPageData_included
...
class UsageOptPageData : public QDialog
{
    Q_OBJECT
...
#endif // UsageOptPageData_included
